...
$CC -c core/antidebug/antidebug.c    -o build/antidebug.o     $CFLAGS

echo "[*] Linking..."
$CC -T shellcode.ld build/stub.o build/pe.o build/peb.o build/xor.o build/memory.o build/strings.o build/io.o build/veh.o build/antidebug.o -o build/shellcode.elf -nostdlib -Wl,--no-seh
